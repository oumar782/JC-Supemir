      ...
      <section className="hero-section">
        ...
        <div className="hero-content">
          ...
          >
            ...
            exceptionnelle d'échanges, de découvertes et de partage organisée par l'école supérieure multimédia informatique et réseaux (SUPEMIR).
          </motion.p>
          <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
